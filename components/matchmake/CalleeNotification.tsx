  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 p-4">
      <motion.div
        ...
        className={`w-full max-w-lg rounded-2xl bg-[#0a0a0c] shadow-2xl border-2 border-[#fbbf24]/30 ${
      ...
      >
        ...
        <div className={isMobile ? 'space-y-2' : 'space-y-4'}>
          ...
          {invite.fromUser.selfieUrl && (
            <div className={`relative mx-auto overflow-hidden rounded-full border-4 border-[#fbbf24]/30 ${
        ...
        {invite.chatMode === 'text' ? (
          ...
          <div>
            ...
            <input
              ...
              min="60"
              max="500"
              className={`w-full rounded-xl bg-white/10 px-4 text-center font-mono text-[#eaeaf0] focus:outline-none focus:ring-2 focus:ring-[#fbbf24] ${
