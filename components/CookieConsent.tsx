      ...
      {showBanner && (
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="bg-[#0a0a0c]/95 backdrop-blur-lg border border-[#ffc46a]/30 rounded-2xl shadow-2xl p-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                  ...
                  <button
                    onClick={acceptAll}
                    className="px-6 py-2 rounded-xl bg-[#ffc46a] text-[#0a0a0c] 
                             hover:opacity-90 transition-all text-sm font-medium
                             shadow-lg shadow-[#ffc46a]/20"
                  >
                    Accept All
                  </button>
                </div>
