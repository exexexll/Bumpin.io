          ...
          <AnimatePresence>
            {showVideoRequest && !videoRequested && (
              <motion.button
                ...
                className="hidden sm:flex items-center gap-2 rounded-full bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] px-4 py-2 text-sm font-bold text-[#0a0a0c] hover:shadow-lg hover:shadow-[#fbbf24]/50 transition-all shadow-md"
              >
      ...
      <AnimatePresence>
        {showVideoRequest && !videoRequested && (
          ...
          >
            <button
              onClick={handleRequestVideo}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] px-4 py-3 text-sm font-bold text-[#0a0a0c] shadow-lg"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
        ...
        {incomingVideoRequest && (
          ...
          >
            <motion.div
              ...
              className="max-w-md rounded-2xl bg-[#0a0a0c] p-8 shadow-2xl border-2 border-[#fbbf24]/50 text-center"
            >
              <div className="text-6xl mb-4">📹</div>
              <h3 className="font-playfair text-2xl font-bold text-[#eaeaf0] mb-3">
                Upgrade to Video?
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 rounded-xl bg-[#fbbf24] px-6 py-3 font-medium text-[#0a0a0c] hover:opacity-90 transition-opacity"
                >
                  Accept Video
                </button>
              </div>
