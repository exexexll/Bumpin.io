...
function OnboardingPageContent() {
  ...
  return (
    <main id="main" className="min-h-screen bg-[#0a0a0c] py-20">
      {/* Upload Progress Bar */}
      {showUploadProgress && (
        <div className="fixed top-4 right-4 z-50 bg-black/90 backdrop-blur-md rounded-xl p-4 border border-[#fbbf24]/30 shadow-2xl">
          <p className="text-sm text-[#eaeaf0] mb-2 font-medium">Uploading video...</p>
          <div className="w-48 h-2 bg-white/10 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-[#fbbf24] to-[#ff7b4b] transition-all duration-300"
        ...
        <div className="mx-auto max-w-2xl">
          <AnimatePresence mode="wait">
            ...
            {step === 'name' && (
              ...
              >
                {referralCode && (
                  <div className="rounded-2xl border-2 border-[#fbbf24]/30 bg-[#fbbf24]/10 p-6">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-2xl">💝</span>
                      <h3 className="font-playfair text-xl font-bold text-[#fbbf24]">
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                    <label className="flex items-start gap-3 cursor-pointer">
                      <input
                        ...
                        className="mt-1 h-5 w-5 rounded border-white/20 bg-white/10 text-[#fbbf24] 
                                 focus:ring-2 focus:ring-[#fbbf24] focus:ring-offset-0"
                      />
                      <span className="text-sm text-[#eaeaf0]/80">
                        I have read and agree to the{' '}
                        <Link href="/terms-of-service" target="_blank" className="text-[#fbbf24] hover:underline">
                          Terms of Service
                        </Link>
                        ,{' '}
                        <Link href="/privacy-policy" target="_blank" className="text-[#fbbf24] hover:underline">
                          Privacy Policy
                        </Link>
                        , and{' '}
                        <Link href="/content-policy" target="_blank" className="text-[#fbbf24] hover:underline">
                          Content Policy
                        </Link>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="focus-ring flex-1 rounded-xl bg-[#fbbf24] px-6 py-3 font-medium text-[#0a0a0c] shadow-sm transition-opacity hover:opacity-90 disabled:opacity-50"
                    >
