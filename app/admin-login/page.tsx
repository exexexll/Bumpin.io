            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-white/10 px-4 py-3 text-[#eaeaf0] placeholder-[#eaeaf0]/30 focus:outline-none focus:ring-2 focus:ring-[#ffc46a]"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-xl bg-[#ffc46a] px-6 py-3 font-semibold text-[#0a0a0c] transition-all hover:opacity-90 disabled:opacity-50"
              >
