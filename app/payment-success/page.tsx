    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#0a0a0c]">
        <div className="text-center">
          <div className="mb-4 inline-block h-12 w-12 animate-spin rounded-full border-4 border-[#ffc46a] border-t-transparent" />
          ...
          {retryCount > 2 && (
            <div className="mt-6 space-y-3">
              ...
              <button
                ...
                className="rounded-xl bg-[#ffc46a]/20 px-6 py-2 text-sm text-[#ffc46a] hover:bg-[#ffc46a]/30"
              >
